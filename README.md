...
* real emoji shortcuts used, (see [emoji.codes](http://emoji.codes/)), low dash removed, for example _&colon;lion_face&colon;_ is _lion face_ displayed as :lion_face:
